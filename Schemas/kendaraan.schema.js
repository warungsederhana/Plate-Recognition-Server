...
const kendaraanSchema = z.object({
  ...
  id_kepemilikan: z.string().optional(),
  no_kk: z.string(),
  no_polisi: z.string(),
  ...
  id_pendaftara: z.string().optional(),
  ...
  bb1_pokok: z.number().nonnegative(),
  bb1_denda: z.number().nonnegative(),
